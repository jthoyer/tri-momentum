...
| **Plan** (`view-plan`) | Manual entry of the athlete's own planned sessions, a week at a time, with copy-week-forward and clear-week. Synced via the Sheet's `Plan` tab. See decision 28. |
